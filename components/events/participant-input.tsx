...
interface EventParticipantInputProps {
  contacts: Contact[]
  selectedParticipants: Contact[]
  onParticipantsChange: (participants: Contact[]) => void
}

export function EventParticipantInput({ contacts, selectedParticipants, onParticipantsChange }: EventParticipantInputProps) {
