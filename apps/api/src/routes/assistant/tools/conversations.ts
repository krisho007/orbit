  ...
  return {
    create_conversation: tool({
      ...
      inputSchema: z.object({
        ...
        happenedAt: z.string().optional().describe("When it happened as full ISO 8601 datetime, e.g. 2026-02-21T14:30:00.000Z"),
        followUpAt: z.string().optional().describe("Follow-up as full ISO 8601 datetime, e.g. 2026-02-28T09:00:00.000Z"),
    ...
    create_conversation_by_ids: tool({
      ...
      inputSchema: z.object({
        ...
        happenedAt: z.string().describe("When it happened as full ISO 8601 datetime, e.g. 2026-02-21T14:30:00.000Z"),
        followUpAt: z.string().optional().describe("Follow-up as full ISO 8601 datetime, e.g. 2026-02-28T09:00:00.000Z"),
