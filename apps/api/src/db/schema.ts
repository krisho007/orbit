...
export const contacts = pgTable(
  "contacts",
  {
    ...
    dateOfBirth: timestamp("dateOfBirth", { mode: "date", withTimezone: true }),
...
export const conversations = pgTable(
  "conversations",
  {
    ...
    happenedAt: timestamp("happenedAt", { mode: "date", withTimezone: true }).notNull(),
    followUpAt: timestamp("followUpAt", { mode: "date", withTimezone: true }),
...
export const reminders = pgTable(
  "reminders",
  {
    ...
    recurrenceEndsAt: timestamp("recurrenceEndsAt", { mode: "date", withTimezone: true }),
